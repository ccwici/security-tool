...
public class RSAUtils {
	...
	public static void main(String[] args) throws Exception {
		...
		PublicKey pk = ((PublicKey) keypair.get(PUBLIC_KEY));
		byte[] cypertext = encryptByPublicKey("1245".getBytes(), pk.getEncoded());
		//		PrivateKey privateKey = (PrivateKey) genKeyPair().get(PRIVATE_KEY);
		PrivateKey privateKey = ((PrivateKey) keypair.get(PRIVATE_KEY));
		System.out.println(new String(decryptByPrivateKey(cypertext, privateKey.getEncoded())));
	}
}